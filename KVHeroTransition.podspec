...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of KVHeroTransition.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Khanh Vu/KVHeroTransition'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Khanh Vu' => 'vuvankhanh022002@gmail.com' }
  s.source           = { :git => 'https://github.com/Khanh Vu/KVHeroTransition.git', :tag => s.version.to_s }
